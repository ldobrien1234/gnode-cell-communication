...
with torch.no_grad():
    ...
    model_state_dict = torch.load("Cell123_Model.pt")
...
total_J = torch.zeros(nCell,3,nCell,3)
...
J_model = J_model.reshape(nCell*3,nCell*3)

genes = ["G1", "P1", "X1", "G2", "P2", "X2", "G3", "P3", "X3"]
